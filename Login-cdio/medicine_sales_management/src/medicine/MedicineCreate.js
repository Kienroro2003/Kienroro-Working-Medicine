...
export function MedicineCreate(){
    ...
    return (
        <>
            <h1>Tạo mới thuốc</h1>
            <Formik initialValues={{...medicine, id_employee: JSON.stringify(auth?.id)}} onSubmit={(values,{setSubmitting}) => {
                setSubmitting(false);
                    ...
                    ({isSubmitting}) => (
                        <Form>
                            ...
                            <div className="mb-3">
                                ...
                                <Field as="text" className="form-select" name="id_employee" value={auth?.id}>
                                    {auth?.username}
                                </Field>
                            </div>
                            <div className="mb-3">
